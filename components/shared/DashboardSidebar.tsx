...
export function DashboardSidebar({ isAdmin = false, userName, avatarUrl }: SidebarProps) {
  ...
  const adminLinks = [
    ...
    { name: 'Manajemen Kurir', href: '/admin/couriers', icon: Truck },
    { name: 'Zona Layanan', href: '/admin/delivery-zones', icon: Landmark },
    { name: 'Tarif Ongkir', href: '/admin/delivery-fares', icon: Landmark },
    { name: 'Pengiriman Kurir', href: '/admin/deliveries', icon: Truck },
    { name: 'Pencairan Kurir', href: '/admin/courier-payouts', icon: Landmark },
    { name: 'Layanan Mobilitas', href: '/admin/service-types', icon: Settings },
